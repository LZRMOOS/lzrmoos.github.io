...
:root[data-theme="dark"] {
  ...
  --tp-bg-card: #101613;
  --tp-border: #1c2a24;
  --tp-border-bright: #2a4a3a;
  --tp-text: #c9d1cb;
  --tp-text-dim: #6b7d73;
  --tp-text-faint: #445048;
  --tp-accent: #39ff88;
